...
class RecyclerAdapterData1Fragment(val eventList: MutableList<Event>, val questionList: MutableList <Question>) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(event: Event, answer: Question) {
            ...
            itemView.locationData3HolderTV.text = answer.votesyes.toString()
            itemView.nameData2HolderTV.text = event.questions.toString()
